    ...
    <div className="min-h-screen">
      ...
      <section className="mx-auto max-w-7xl px-6 py-20">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {projects.map((p, i) => (
            <article key={p.name} className="group bg-secondary">
        ...
        <div className="mt-16 flex flex-wrap items-center justify-between gap-6 bg-brand px-8 py-12 text-brand-foreground">
